...
function MedicalEmergency() {
  ...
  const { 
    emergencyLoading, 
    handleSOS 
  } = useEmergencyService(safeLocation);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Find nearby medical help when you need it most
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-6">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 gap-3">
                  {guides
                    .filter((guide) => guide.category === "medical")
                    .map((guide) => (
                      <div
                        key={guide.id}
                                        ...
                                        <div>
                                          ...
                                          <p className="text-sm mt-1">
                                            {serviceDetails.placeDetails
                                              .phone !== "Not available" ? (
                                              <a
                                                href={`tel:${serviceDetails.placeDetails.phone.replace(
                                                  /^0/,
                                                  "+91"
                                                )}`}
